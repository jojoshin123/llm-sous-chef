...
[**LLM Sous Chef**](https://llmsouschef.jonzh.org/) will take in a URL to a cooking social media video post and convert it to a coherent recipe, which you can easily save to a collection of cookbooks under your account.
